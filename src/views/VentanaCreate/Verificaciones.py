...
###### INSERCIÓN A LA BASE DE DATOS ##########################
    ...
    def prCero(self,*tpl):           # Función que verifica si al Inicio del Fromulario los campos estan vaciós para evitar inserción de campos vacios
       # tpl = self.tplInpts()
        ji = []
    ...
    def pruData(self,*dic):
        ...
        if len(dic2) !=0:
            ...
            if not contact_exists:
                ...
                self.page.overlay.append(self.mdlDplctPrdct)
                self.mdlDplctPrdct.open = True
                self.page.update()
